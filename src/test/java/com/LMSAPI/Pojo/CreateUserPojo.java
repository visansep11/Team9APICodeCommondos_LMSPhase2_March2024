...
public class CreateUserPojo {
	...
	private CreateUser_userLogin userLogin;
	private List <CreateUser_userRoleMaps> userRoleMaps;
	...
	public List<CreateUser_userRoleMaps> getUserRoleMaps() {
		return userRoleMaps;
	}
	public void setUserRoleMaps(List<CreateUser_userRoleMaps> userRoleMaps) {
		this.userRoleMaps = userRoleMaps;
	}
	public CreateUser_userLogin getUserLogin() {
		return userLogin;
	}
	public void setUserLogin(CreateUser_userLogin userLogin) {
